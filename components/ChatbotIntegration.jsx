...
export default function ChatbotIntegration({ prevStep, userData }) {
  const [integrationStatus, setIntegrationStatus] = useState("pending");

  const handleTestChatbot = () => {
    window.open(`https://${userData.companyWebsite}`, "_blank");
  };
  ...
  const handleMailInstructions = () => {
    // Implement mailing instructions logic here
    console.log("Mailing instructions");
  };
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold mb-4">Chatbot Integration & Testing</h2>
      <div className="space-y-4">
        ...
        {integrationStatus === "success" && (
          <motion.div
            ...
            className="text-center"
          >
            <h3 className="text-xl font-bold mb-2">Integration Successful!</h3>
  ...
  BeyondChats.init({
    ...
    theme: "light"
          ...
          <button
            ...
            className="mt-2 w-full bg-gray-200 text-gray-700 py-2 rounded-md hover:bg-gray-300 transition-colors"
          >
